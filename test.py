...
#行分割
def  get_horizontal_seg_array(txt_pixels):
    start_i = -1
    end_i = -1
...
#列分割
def get_vertical_seg_array(txt_pixels):
    start_i = -1
    end_i = -1
...
def main():
    # root,path = get_image('d:\\python\\program\\','12,jpg')
    # rowPairsArray = get_horizontal_seg_array(txt_pixels)
    # horizontal_img_write(rowPairsArray, txt_pixels,label)
    # rowPairsArray = get_vertical_seg_array(txt_pixels)
